...
erDiagram
    ...
    COMPANIES ||--o{ INTAKE_SUBMISSIONS : "originates_from"

    CONTACTS ||--o{ DEALS : "champions"
    CONTACTS ||--o{ TASKS : "assigned_subject"
    CONTACTS ||--o{ INVOICES : "attention_to"

    DEALS ||--o{ TASKS : "has"
    DEALS ||--o{ INVOICES : "billed_for"

    USERS ||--o{ COMPANIES : "owns"
    USERS ||--o{ CONTACTS : "owns/assigned_to"
    USERS ||--o{ DEALS : "owns/assigned_to"
    USERS ||--o{ TASKS : "owns/assigned_to"
    ...
    INVOICES {
        ...
        float amount
        string status
        json lineItems "Embedded JSON Array"
        string companyId FK
        string contactId FK
        string dealId FK
    }
